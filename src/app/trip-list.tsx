...
const styles = StyleSheet.create({
  ...
  // 設定配下ページ（settings.tsxのhero等）と同じ黒ヒーローカード表現に統一。
  // 背景=color.dark、主要文字=白、補助文字/アクセント=color.primaryAccentに揃える。
  activeCard: {
  ...
  activeName: { fontSize: 18, fontWeight: '700', color: '#FFFFFF', flexShrink: 1 },
  usingBadge: { backgroundColor: color.primaryAccent, borderRadius: radius.pill, paddingHorizontal: 8, paddingVertical: 2 },
  usingBadgeText: { fontSize: 11, fontWeight: '700', color: color.dark },
  activeRate: { fontSize: 12.5, lineHeight: 17, fontWeight: '700', color: color.primaryAccent, fontVariant: ['tabular-nums'] },
  budgetRow: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between' },
  budgetLabel: { fontSize: 12, fontWeight: '700', color: color.primaryAccent, marginBottom: 2 },
  budgetValue: { fontSize: 30, lineHeight: 36, fontWeight: '700', color: '#FFFFFF', letterSpacing: -0.4, fontVariant: ['tabular-nums'] },
  budgetMeta: { alignItems: 'flex-end', gap: 2 },
  budgetMetaText: { fontSize: 12, fontWeight: '500', color: color.darkSub, fontVariant: ['tabular-nums'] },
  ...
  actionBtn: { flex: 1, borderRadius: radius.button, borderWidth: 1.5, borderColor: color.primaryAccent, paddingVertical: 11, alignItems: 'center' },
  actionBtnText: { fontSize: 14, fontWeight: '700', color: color.primaryAccent },
