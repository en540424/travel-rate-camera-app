// Web用 カメラプレビューモック（明示的 .web.tsx — Metro が .native.tsx より優先採用する）
// OCR・カメラ処理は一切実行しない。金額入力・換算は index.tsx の inputCard で行う。
  ...
  return (
    <View style={styles.feed}>
      ...
      <View style={styles.scanHint}>
        ...
        <ThemedText style={styles.webNote}>（Web版：OCR非対応）</ThemedText>
      </View>
    </View>
  );
}
